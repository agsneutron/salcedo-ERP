...
class Employee(models.Model):
    ...
    phone_number = models.IntegerField(verbose_name="Teléfono*", null=False, blank=False, default=0)
    cellphone_number = models.IntegerField(verbose_name="Celular", null=False, blank=True, default=0)
    office_number = models.IntegerField(verbose_name="Teléfono de Oficina", null=False, blank=True, default=0)
    extension_number = models.IntegerField(verbose_name="Número de Extensión", null=False, blank=True, default=0)
    ...
    zip_code = models.IntegerField(verbose_name="Código Postal*", null=False, blank=False, default=0)
...
class FamilyMember(models.Model):
    ...
    phone_number = models.IntegerField(verbose_name="Número de Teléfono", null=True, blank=True, default=0)
...
class EmergencyContact(models.Model):
    ...
    second_last_name = models.CharField(verbose_name="Apellido Materno*", max_length=255, null=False, blank=False)
    phone_number = models.IntegerField(verbose_name="Número de Teléfono", null=True, blank=True, default=0)
    cellphone_number = models.IntegerField(verbose_name="Número de Celular", null=True, blank=True, default=0)
...
class WorkReference(models.Model):
    ...
    first_phone_number = models.IntegerField(verbose_name="Número de Teléfono #1", null=False, blank=False, default=0)
    second_phone_number = models.IntegerField(verbose_name="Número de Teléfono #2", null=True, blank=True, default=0)
    email = models.CharField(verbose_name="Correo Electrónico", max_length=255, null=True, blank=True)
