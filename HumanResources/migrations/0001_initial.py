# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2018-04-20 14:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('abilities', models.TextField(blank=True, max_length=2048, verbose_name='Habilidades')),
                ('aptitudes', models.TextField(blank=True, max_length=2048, verbose_name='Aptitudes')),
                ('knowledge', models.TextField(blank=True, max_length=2048, verbose_name='Conocimientos')),
                ('competitions', models.TextField(blank=True, max_length=2048, verbose_name='Competencias')),
                ('scholarship', models.TextField(blank=True, max_length=2048, verbose_name='Escolaridad ')),
                ('experience', models.TextField(blank=True, max_length=2048, verbose_name='Experiencia')),
