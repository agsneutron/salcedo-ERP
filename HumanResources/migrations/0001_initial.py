    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registry_date', models.DateField(default=datetime.datetime(2017, 11, 21, 7, 25, 41, 103023, tzinfo=utc), verbose_name='Fecha de Registro')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bank', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ERP.Bank', verbose_name='Banco')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='HumanResources.Employee', verbose_name='Empleado')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_plan', models.IntegerField(choices=[(1, 'Plan A (12 meses)'), (2, 'Plan B (14 meses)')], default=1, verbose_name='Plan de Pago')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('period', models.IntegerField(default=22, verbose_name='Periodo a Cobrar')),
