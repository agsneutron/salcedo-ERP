# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-11-07 16:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registry_date', models.DateField(default=datetime.datetime(2017, 11, 7, 16, 24, 37, 202958, tzinfo=utc), verbose_name='Fecha de Registro')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(default=datetime.datetime(2017, 11, 7, 16, 24, 37, 229815, tzinfo=utc), verbose_name='Fecha')),
                ('entry_time', models.TimeField(default=datetime.datetime(2017, 11, 7, 16, 24, 37, 229855, tzinfo=utc), verbose_name='Hora de Entrada')),
                ('exit_time', models.TimeField(default=datetime.datetime(2017, 11, 7, 16, 24, 37, 229884, tzinfo=utc), verbose_name='Hora de Salida')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('days_attendance', models.CharField(choices=[('L', 'Lunes'), ('M', 'Martes'), ('X', 'Mi\xe9rcoles'), ('J', 'Jueves'), ('V', 'Viernes'), ('S', 'S\xe1bado'), ('D', 'Domingo')], max_length=1, null=True, verbose_name='D\xedas Laborales')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='HumanResources.Employee', verbose_name='Empleado')),
            ],
            options={
