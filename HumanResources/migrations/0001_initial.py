# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-11-08 07:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registry_date', models.DateField(default=datetime.datetime(2017, 11, 8, 7, 24, 22, 536252, tzinfo=utc), verbose_name='Fecha de Registro')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(default=datetime.datetime(2017, 11, 8, 7, 24, 22, 561445, tzinfo=utc), verbose_name='Fecha')),
                ('entry_time', models.TimeField(default=datetime.datetime(2017, 11, 8, 7, 24, 22, 561509, tzinfo=utc), verbose_name='Hora de Entrada')),
                ('exit_time', models.TimeField(default=datetime.datetime(2017, 11, 8, 7, 24, 22, 561574, tzinfo=utc), verbose_name='Hora de Salida')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('days_attendance', multiselectfield.db.fields.MultiSelectField(choices=[('L', 'Lunes'), ('M', 'Martes'), ('X', 'Mi\xe9rcoles'), ('J', 'Jueves'), ('V', 'Viernes'), ('S', 'S\xe1bado'), ('D', 'Domingo')], max_length=1, null=True, verbose_name='D\xedas Laborales')),
        ...
        migrations.AddField(
            ...
            name='payroll_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='HumanResources.PayrollType', verbose_name='Empleado'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='HumanResources.EarningsDeductionsCategory', verbose_name='Categoria'),
        ),
        migrations.AddField(
            model_name='earningsdeductions',
            name='taxable',
