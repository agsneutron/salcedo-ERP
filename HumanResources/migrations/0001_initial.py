    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.TextField(max_length=500, verbose_name='Observaciones')),
                ...
                ('account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='SharedCatalogs.Account', verbose_name='Cuenta')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.IntegerField(blank=True, max_length=20, null=True, verbose_name='N\xfamero de Tel\xe9fono')),
                ('cellphone_number', models.IntegerField(blank=True, max_length=20, null=True, verbose_name='N\xfamero de Celular')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_last_name', models.CharField(max_length=255, verbose_name='Apellido Paterno')),
                ('second_last_name', models.CharField(max_length=255, verbose_name='Apellido Materno')),
                ('photo', models.FileField(blank=True, null=True, upload_to=HumanResources.models.upload_employee_photo, verbose_name='Foto')),
                ('type', models.IntegerField(choices=[(1, 'Empleado Tipo A'), (2, 'Empleado Tipo B')], default=1, verbose_name='Tipo de Empleado')),
                ...
                ('phone_number', models.IntegerField(max_length=20, verbose_name='Tel\xe9fono')),
                ('cellphone_number', models.IntegerField(blank=True, max_length=20, verbose_name='Celular')),
                ('office_number', models.IntegerField(blank=True, max_length=20, verbose_name='Tel\xe9fono de Oficina')),
                ('extension_number', models.IntegerField(blank=True, max_length=10, verbose_name='N\xfamero de Extensi\xf3n')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(1, 'Despido'), (2, 'Renuncia'), (3, 'Incapacidad')], default=1, verbose_name='Tipo de Baja')),
                ...
                ('observations', tinymce.models.HTMLField(blank=True, max_length=4096, null=True, verbose_name='Observaciones')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='HumanResources.Employee', verbose_name='Empleado')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CLABE', models.IntegerField(default=0, verbose_name='Clave*')),
                ...
                ('bank', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SharedCatalogs.Bank', verbose_name='Banco*')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='HumanResources.Employee', verbose_name='Empleado')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('career', models.CharField(blank=True, max_length=128, verbose_name='Profesi\xf3n')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.TextField(blank=True, max_length=500, null=True, verbose_name='Observaciones')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fortnight', models.IntegerField(default=1, validators=[django.core.validators.MaxValueValidator(24), django.core.validators.MinValueValidator(1)], verbose_name='Semana')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_phone_number', models.IntegerField(max_length=20, verbose_name='N\xfamero de Tel\xe9fono #1')),
                ('second_phone_number', models.IntegerField(blank=True, max_length=20, null=True, verbose_name='N\xfamero de Tel\xe9fono #2')),
                ('email', models.CharField(blank=True, max_length=255, null=True, verbose_name='Correo Electr\xf3nico')),
        ...
        migrations.AddField(
            ...
            name='payroll_group',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='HumanResources.PayrollGroup', verbose_name='Grupo'),
        ),
        migrations.AddField(
            model_name='employeeloandetail',
            name='period',
            field=smart_selects.db_fields.ChainedForeignKey(auto_choose=True, chained_field='payroll_group', chained_model_field='payroll_group', on_delete=django.db.models.deletion.CASCADE, to='HumanResources.PayrollPeriod'),
        ),
        migrations.AddField(
