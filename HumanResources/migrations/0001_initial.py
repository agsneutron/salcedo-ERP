# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-11-11 04:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registry_date', models.DateField(default=datetime.datetime(2017, 11, 11, 4, 34, 35, 950625, tzinfo=utc), verbose_name='Fecha de Registro')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(default=datetime.datetime(2017, 11, 11, 4, 34, 35, 971033, tzinfo=utc), verbose_name='Fecha')),
                ('entry_time', models.TimeField(default=datetime.datetime(2017, 11, 11, 4, 34, 35, 971075, tzinfo=utc), verbose_name='Hora de Entrada')),
                ('exit_time', models.TimeField(default=datetime.datetime(2017, 11, 11, 4, 34, 35, 971105, tzinfo=utc), verbose_name='Hora de Salida')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sunday', models.BooleanField(default=False, verbose_name='Domingo')),
                ('payroll_classification', models.CharField(choices=[('C', 'Corporativa'), ('P', 'Proyecto')], default='C', max_length=1, verbose_name='Clasificaci\xf3n de N\xf3mina')),
