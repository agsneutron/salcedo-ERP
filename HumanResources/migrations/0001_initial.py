# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-11-29 18:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.CharField(blank=True, max_length=255, null=True, validators=[django.core.validators.RegexValidator(message='Asegurate de que el correo electr\xf3nico que proporcionas sea correcto.', regex="\\w+([-+.']\\w+)*@\\w+([-.]\\w+)*\\.\\w+([-.]\\w+)*")], verbose_name='Correo Electr\xf3nico')),
                ('colony', models.CharField(max_length=255, verbose_name='Colonia*')),
                ('street', models.CharField(max_length=255, verbose_name='Calle*')),
                ('outdoor_number', models.CharField(max_length=10, verbose_name='No. Exterior*')),
                ('indoor_number', models.CharField(blank=True, max_length=10, null=True, verbose_name='No. Interior')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('personal_email', models.CharField(max_length=255, null=True, validators=[django.core.validators.RegexValidator(message='Asegurate de que el correo electr\xf3nico que proporcionas sea correcto.', regex="\\w+([-+.']\\w+)*@\\w+([-.]\\w+)*\\.\\w+([-.]\\w+)*")], verbose_name='Correo Electr\xf3nico Personal*')),
                ('work_email', models.CharField(blank=True, max_length=255, null=True, validators=[django.core.validators.RegexValidator(message='Asegurate de que el correo electr\xf3nico que proporcionas sea correcto.', regex="\\w+([-+.']\\w+)*@\\w+([-.]\\w+)*\\.\\w+([-.]\\w+)*")], verbose_name='Correo Electr\xf3nico Laboral')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(1, 'Termino de Contrato'), (2, 'Separaci\xf3n Voluntaria'), (3, 'Abandono del Empleo'), (4, 'Defunci\xf3n'), (5, 'Ausentismo'), (6, 'Rescisi\xf3n de Contrato'), (7, 'Pensionado'), (8, 'Otra')], default=1, verbose_name='Motivo de Baja')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.TextField(blank=True, max_length=500, null=True, validators=[django.core.validators.RegexValidator(message='\xc9ste campo no acepta caracateres como: +*/{] .', regex="[a-zA-Z\xe0\xe1\xe2\xe4\xe3\xe5\u0105\u010d\u0107\u0119\xe8\xe9\xea\xeb\u0117\u012f\xec\xed\xee\xef\u0142\u0144\xf2\xf3\xf4\xf6\xf5\xf8\xf9\xfa\xfb\xfc\u0173\u016b\xff\xfd\u017c\u017a\xf1\xe7\u010d\u0161\u017e\xc0\xc1\xc2\xc4\xc3\xc5\u0104\u0106\u010c\u0116\u0118\xc8\xc9\xca\xcb\xcc\xcd\xce\xcf\u012e\u0141\u0143\xd2\xd3\xd4\xd6\xd5\xd8\xd9\xda\xdb\xdc\u0172\u016a\u0178\xdd\u017b\u0179\xd1\xdf\xc7\u0152\xc6\u010c\u0160\u017d\u2202\xf0 ,.'-]")], verbose_name='Observaciones')),
                ('employee_financial_data', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='HumanResources.EmployeeFinancialData')),
            ],
            options={
