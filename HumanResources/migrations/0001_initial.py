# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2017-11-06 19:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registry_date', models.DateField(default=datetime.datetime(2017, 11, 6, 19, 26, 4, 33742, tzinfo=utc), verbose_name='Fecha de Registro')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(default=datetime.datetime(2017, 11, 6, 19, 26, 4, 51172, tzinfo=utc), verbose_name='Fecha')),
                ('entry_time', models.TimeField(default=datetime.datetime(2017, 11, 6, 19, 26, 4, 51217, tzinfo=utc), verbose_name='Hora de Entrada')),
                ('exit_time', models.TimeField(default=datetime.datetime(2017, 11, 6, 19, 26, 4, 51250, tzinfo=utc), verbose_name='Hora de Salida')),
