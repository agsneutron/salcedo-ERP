...
class EstimateReportsForContractors(object):
    ...
    def generate_report(information_json,):
        if len(information_json) == 0:
            ...
            for contractor in information_json['data']:
                ...
                EstimateReportsForContractors.add_headers(workbook, worksheet, information_json, contractor)
                EstimateReportsForContractors.add_estimates_table(workbook, worksheet, contractor['estimates'])
        ...
        response['Content-Disposition'] = 'attachment; filename=Estimaciones_de_los_Contratistas.xlsx'
    ...
    def add_headers(workbook, worksheet, general_info, contractor_info):
        ...
        formats = EstimateReportsForContractors.get_formats(workbook)
