...
function displayResults(data){
    ...
    sTable= '<thead>'
                        +'<tr>'
                            ...
                            +'<th>Registro</th>'
                            +'<th>Descripción</th>'
                            +'<th width="5%" class="no-sorting text-center">Ver</th>'
                            +'<th width="5%" class="no-sorting text-center">Editar</th>'
                            +'<th width="5%" class="no-sorting text-center">Eliminar</th>'
    ...
    for (var i = 0; i < data.length; i++) {
            ...
            + '<td style="width: 2px" class=" text-center"><a href="/admin/Accounting/accountingpolicy/' + data[i].id + '/" class="btn btn-raised btn-default btn-xs"><i class ="fa fa-eye color-default eliminar" > </i></a></td>'
            + '<td style="width: 2px" class=" text-center"><a href="/admin/Accounting/accountingpolicy/' + data[i].id + '/change" class="btn btn-raised btn-default btn-xs"><i class ="fa fa-pencil color-default eliminar" > </i></a></td>'
            + '<td style="width: 2px" class=" text-center"><a href="/admin/Accounting/accountingpolicy/' + data[i].id + '/delete" class="btn btn-raised btn-default btn-xs"><i class ="fa fa-trash-o color-danger eliminar" > </i></a></td>'
            + '</tr>'
    }
