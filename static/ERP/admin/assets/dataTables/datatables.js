 ...
 *   https://datatables.net/download/#bs/dt-1.10.16/cr-1.4.1/r-2.2.0
 *
 * Included libraries:
...
(function( $, window, document, undefined ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<button class="searchbutton" type="submit" style="margin-right: 0px; float: left"><i class="fa fa-search"></i> </button>' + '<input type="search" class="' + classes.sFilterInput + '' + ' form-control searchfield' + '"/>';
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs/dt-1.10.16/cr-1.4.1/r-2.2.0",
