...
class Estado(models.Model):
	nombre_estado = models.CharField(verbose_name="Nombre de Estado", max_length=100, null=False, blank=False,
									 unique=True, db_index=True)
	clave_estado = models.CharField(verbose_name="Clave de Estado", max_length=2, null=False, blank=False, unique=True)
	abrev_estado = models.CharField(verbose_name="Abreviación del Estado", max_length=16, null=False, blank=False)
	actualizacion = models.DateTimeField(auto_now=True)
	creacion = models.DateTimeField(auto_now_add=True)

	#folio = models.CharField(verbose_name="Folio", max_length=36, null=True)
	...
	def __str__(self):  # __unicode__ on Python 2
		return self.nombre_estado.__str__()

	def to_serilizable_dic(self):
		ans = model_to_dict(self)
		ans['id'] = str(self.id)
		ans['nombre_estado'] = str(self.nombre_estado)
		return ans
...
class Project(models.Model):
    ...
    tipo_construccion = models.ForeignKey(TipoConstruccion, verbose_name="tipo de construcción", null=False , blank=False)
    ...
    area_superficie_levantamiento = models.DecimalField(verbose_name='superficie levantamiento', decimal_places=2, blank=False, null=False, default=0, max_digits=20)
    ...
    usosuelo_loteminimo = models.DecimalField(verbose_name='lote mínimo', decimal_places=2, blank=False, null=False, default=0, max_digits=20)
    usosuelo_m2construccion = models.DecimalField(verbose_name='m2 de construcción', decimal_places=2, blank=False, null=False, default=0, max_digits=20)
    ...
    usosuelo_densidadrequerida = models.CharField(verbose_name="densidad requerida", max_length=200, null=False, blank=False)
    ...
    vial_estadoconstruccion = models.CharField(verbose_name="estado de construcción", max_length=200, null=False, blank=False)
    ...
    alumbradopublico_observaciones = models.CharField(verbose_name="dobservaciones", max_length=200, null=False, blank=False)
    ...
    programayarea_jardin = models.DecimalField(verbose_name='jardín', decimal_places=2, blank=False, null=False, default=0, max_digits=20)
    programayarea_vialidad = models.DecimalField(verbose_name='vialidad', decimal_places=2, blank=False, null=False, default=0, max_digits=20)
    programayarea_areaverde = models.DecimalField(verbose_name='área verde', decimal_places=2, blank=False, null=False, default=0, max_digits=20)
    programayarea_estacionamientovisita = models.DecimalField(verbose_name='estacionamiento visita', decimal_places=2, blank=False, null=False, default=0, max_digits=20)
    programayarea_afectacion = models.DecimalField(verbose_name='afectación', decimal_places=2, blank=False, null=False, default=0, max_digits=20)
...
class Departamento(models.Model):
    nombreDepartamento = models.TextField(verbose_name='Departamento', max_length=120, null=False, blank=False, editable=True)
    descripcion = models.TextField(verbose_name='Descripción', max_length=250, null=False, blank=False, editable=True)
...
class ModalidadContrato(models.Model):
    modalidadContrato = models.CharField(verbose_name='Contrato', max_length=250, null=False, blank=False, editable=True)
    duracionContrato = models.CharField(verbose_name='Duración de Contrato', max_length=20, null=False, blank=False, editable=True)
...
class Contratista(models.Model):
    ...
    colonia = models.TextField(verbose_name='Colonia', max_length=50, null=False, blank=False, editable=True)
    municipio = models.ForeignKey(Municipio, verbose_name='Municipio', null=False, blank=False)
    estado = models.ForeignKey(verbose_name='Estado', null=False, blank=False)
    pais = models.ForeignKey(Pais, verbose_name="pais", null=False, blank=False)
    cp = models.CharField(verbose_name='C.P.', max_length=20, null=False, blank=False, editable=True)
    rfc = models.TextField(verbose_name='RFC', max_length=20, null=False, blank=False, editable=True)
